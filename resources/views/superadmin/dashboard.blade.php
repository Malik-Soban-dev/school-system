...
(() => {
    ...
    const showSchoolDetail = async schoolId => {
        ...
        featurePanel.innerHTML = `<h3>Module access overrides</h3><p>Inherit the selected plan unless this school needs an explicit exception.</p><div class="platform-table-wrap"><table><thead><tr><th>Feature</th><th>Access</th></tr></thead><tbody>${featureRows}</tbody></table></div>`;
