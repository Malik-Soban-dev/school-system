...
<main class="platform-shell" id="platform-dashboard">
    ...
    <section class="platform-panel">
        ...
        <div class="platform-table-wrap"><table><thead><tr><th>School</th><th>Branch</th><th>Status</th><th>Members</th><th>Students</th><th>Staff</th><th>Teachers</th><th>Guardians</th><th>Classes</th><th>Open invoices</th><th>Control</th></tr></thead><tbody id="branch-rows"><tr><td colspan="11">Loading branch registry…</td></tr></tbody></table></div><div id="branch-pagination"></div>
    </section>
...
(() => {
    ...
    const loadBranches = async (page = 1) => {
        ...
        branchPagination.querySelectorAll('[data-branch-page]').forEach(button => button.addEventListener('click', () => loadBranches(Number(button.dataset.branchPage)).catch(error => { branchRows.innerHTML = `<tr><td colspan="11">${esc(error.message)}</td></tr>`; })));
