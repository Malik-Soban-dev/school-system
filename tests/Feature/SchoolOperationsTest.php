...
class SchoolOperationsTest extends TestCase
{
    ...
    public function test_owner_can_read_a_monthly_branch_financial_statement_but_other_roles_cannot(): void
    {
        ...
        $this->actingAs($owner)->getJson('/portal/branch-financial-statement?branch_id='.$branchId.'&month=2026-09')->assertOk()->assertJsonCount(3, 'trend')->assertJsonPath('branch.id', $branchId)->assertJsonPath('period', '2026-09')->assertJsonPath('period_status', 'open')->assertJsonPath('year_to_date.year', '2026')->assertJsonPath('year_to_date.through', '2026-09')->assertJsonPath('year_to_date.months_included', 9)->assertJsonPath('year_to_date.metrics.billed', 10000)->assertJsonPath('year_to_date.metrics.collected', 4000)->assertJsonPath('year_to_date.metrics.outstanding', 6000)->assertJsonPath('trend.0.period', '2026-09')->assertJsonPath('trend.0.period_status', 'open')->assertJsonPath('trend.2.period', '2026-07')->assertJsonPath('trend.2.period_status', 'closed')->assertJsonPath('comparison.period', '2026-08')->assertJsonPath('comparison.period_status', 'closed')->assertJsonPath('comparison.metrics.collected', 0)->assertJsonPath('metrics.billed', 10000)->assertJsonPath('metrics.collected', 4000)->assertJsonPath('metrics.outstanding', 6000)->assertJsonPath('metrics.overdue', 6000)->assertJsonPath('metrics.expenses', 2500)->assertJsonPath('metrics.payroll_disbursed', 0)->assertJsonPath('metrics.receipts', 1)->assertJsonPath('metrics.methods.0.method', 'cash')->assertJsonPath('metrics.methods.0.amount', 4000)->assertJsonPath('metrics.outstanding_invoices', 1)->assertJsonPath('metrics.overdue_invoices', 1)->assertJsonPath('metrics.aging.1_30', 6000);
