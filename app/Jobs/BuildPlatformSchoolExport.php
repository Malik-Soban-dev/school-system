...
class BuildPlatformSchoolExport implements ShouldQueue
{
    ...
    private const SCHOOL_TABLES = [
        ...
        'school_staff', 'school_students', 'school_student_welfare', 'school_guardian_links', 'school_teacher_assignments', 'school_attendance',
        'school_timetables', 'school_exams', 'school_grades', 'school_invoices', 'school_payments', 'school_expenses',
